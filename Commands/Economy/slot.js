...
module.exports = { 
    ...
    start: async ( 
      ...
      if (today.getDay() == 6 || today.getDay() == 5 || today.getDay() == 0){
          ...
          if (text == 'money') return m.reply(`*1:* Small Win --> +🪙50\n\n*2:* Small Lose --> -🪙20\n\n*3:* Big Win --> +🪙1000\n\n*4:* Big Lose --> -🪙50\n\n*5:* 🎉 JackPot --> +🪙10000`)
          const fruit1= ["🥥", "🍎", "🍇"]
          const fruit2 = ["🍎", "🍇", "🥥"]  
          const fruit3 = ["🍇", "🥥", "🍎"]         
          const fruit4 = ["🍇", "🥥", "🍎"]
          ...
          if ((f1 !== f2) && f2 !== f3){
             ...
             const give1 = await eco.give(user, cara, 1000); 
                   m.reply(`${mess2}\n*_Big Win -->* _🪙1000_`)
          }
          else if ((f1 == f2) && f2 !== f3){
             const give2 = await eco.give(user, cara, 50);
                   m.reply(`${mess3}\n*Small Win -->* _🪙50_`)
          }
          else if ((f1 !== f2) && f1 == f3){
             ...
             const give5 = eco.give(user, cara, 10000);
                ...
                m.reply(`*You can only play tphis ga
       else{
